...
class IdentifierParser extends GenericElemParser implements Parser<XMLElement> {
    parse(xml: XMLElement): Identifier {
        return {
            ...super.parse(xml),
            type: Identifier,
            collection: queryAndParseElements<CollectionEl>(xml, 'collection', createParser(RepositoryParser, this.genericParse)),
...
export class MsIdentifierParser extends IdentifierParser implements Parser<XMLElement> {
    parse(xml: XMLElement): MsIdentifier {
        ...
        return {
            ...
            altIdentifier: queryAndParseElements<AltIdentifier>(xml, 'altIdentifier', createParser(AltIdentifierParser, this.genericParse)),
            msName: queryAndParseElements<MsName>(xml, 'msName', createParser(MsNameParser, this.genericParse)),
            country: unhandledElement(xml, 'country', this.genericParse),
        };
    }
}
...
export class MsDescParser extends MsPartParser implements Parser<XMLElement> {
    parse(xml: XMLElement): MsDesc {
        ...
        return {
            ...
            type: MsDesc,
            id: getID(xml),
            msFrag: queryAndParseElements(xml, 'msFrag', createParser(MsFragParser, this.genericParse)),
        };
    }
}
