...
import { EditionStmtParser, FileDescParser, PublicationStmtParser, RespParser, RespStmtParser, TitleStmtParser } from './header-parser';
import {
...
type HeaderTags = 'editionStmt' | 'fileDesc' | 'publicationStmt' | 'titleStmt';
